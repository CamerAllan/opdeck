...
//   //     expect(t.changePillar(pillars.tp1, "Army", 2).Army.value).toBe(2);
//   //   });
//   //   it("should cap pillar value at max", () => {
//   //     expect(t.changePillar(pillars.tp1, "Army", 100).Army.value).toBe(10);
//   //   });
//   //   it("should cap pillar value at min", () => {
//   //     expect(t.changePillar(pillars.tp1, "Army", -100).Army.value).toBe(0);
//   //   });
//   // });
// });
